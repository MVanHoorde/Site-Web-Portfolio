...
- Fiche : **aucune — c'est le seul manque du chapitre**. Elle conditionne le bouton « Télécharger la fiche (vierge) » du lot E, posé partout ailleurs où une fiche existe. Jalon 6, verrouillé par le jalon 5 (« cours VALIDÉ », acte explicite de Loïc). Le brief de la fiche est le **lot G de l'audit 3** — il n'existe pas de `BRIEF-CLAUDE-CODE-T3C1-fiche.md` dans le dépôt, contrairement à ce qu'annonçait cette ligne. Code de déblocage : **S0NORE**.
